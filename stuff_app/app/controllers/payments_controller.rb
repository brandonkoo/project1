...
class Payment < ActiveRecord::Base
  ...
  :responseMessage, :amount, :amountReceived, :cardNumber, :cardType, :cardTypeCode, :responseCode,    :transactionID, :xref, :cardNumber, :cardCVV, :cardExpiryMonth, :cardExpiryYear



  def index
    @payments = Payment.new(request_data)
  ...
  def create
    ...
    @payments = Payment.new(request_data) #(params[:prod_name, :description, :price])
