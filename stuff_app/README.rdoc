...
User story:
As a user, I want to create a user account on the web site for security and making purchase.
...
Database relationship: customers, products, order_statuses has many orders.
...
https://sleepy-citadel-2389.herokuapp.com/
